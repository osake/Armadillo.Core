...
import Armadillo.Communication.zmq.zmq.DecoderBase;
import Armadillo.Communication.zmq.zmq.EncoderBase;
import Armadillo.Communication.zmq.zmq.SocketBase;
import Armadillo.Communication.zmq.zmq.ZError;
...
public class ZMQ {
     ...
     */
    public static final int SNDMORE =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDMORE;
    
    // Values for flags in Socket's send and recv functions.
    /**
     * Socket flag to indicate a nonblocking send or recv mode.
     */
    public static final int DONTWAIT =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_DONTWAIT;
    public static final int NOBLOCK =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_DONTWAIT;
    
    // Socket types, used when creating a Socket.
    /**
     * Flag to specify a exclusive pair of sockets.
     */
    public static final int PAIR =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_PAIR;
    /**
     * Flag to specify a PUB socket, receiving side must be a SUB or XSUB.
     */
    public static final int PUB =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_PUB;
    /**
     * Flag to specify the receiving part of the PUB or XPUB socket.
     */
    public static final int SUB =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SUB;
    /**
     * Flag to specify a REQ socket, receiving side must be a REP.
     */
    public static final int REQ =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_REQ;
    /**
     * Flag to specify the receiving part of a REQ socket.
     */
    public static final int REP =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_REP;
    /**
     ...
     */
    public static final int DEALER =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_DEALER;
    /**
    ...
    */
     ...
     */
    public static final int ROUTER =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_ROUTER;
    /**
     ...
     */
    public static final int PULL =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_PULL;
    /**
     * Flag to specify a PUSH socket, receiving side must be a PULL.
     */
    public static final int PUSH =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_PUSH;
    /**
     ...
     */
    public static final int XPUB =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_XPUB;
    /**
     * Flag to specify the receiving part of the PUB or XPUB socket. Allows
     */
    public static final int XSUB =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_XSUB;

    /**
     * Flag to specify a STREAMER device.
     */
    public static final int STREAMER =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_STREAMER ;
    /**
     * Flag to specify a FORWARDER device.
     */
    public static final int FORWARDER =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_FORWARDER ;
    /**
     * Flag to specify a QUEUE device.
     */
    public static final int QUEUE =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_QUEUE ;
    ...
    public static final int POLLIN =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_POLLIN;
    public static final int POLLOUT =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_POLLOUT;
    public static final int POLLERR =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_POLLERR;
    
    /**
     * ZMQ Events
     */
    public static final int EVENT_CONNECTED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_CONNECTED;
    public static final int EVENT_DELAYED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_CONNECT_DELAYED;
    public static final int EVENT_RETRIED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_CONNECT_RETRIED;
    public static final int EVENT_CONNECT_FAILED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_CONNECT_FAILED;

    public static final int EVENT_LISTENING =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_LISTENING;
    public static final int EVENT_BIND_FAILED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_BIND_FAILED;

    public static final int EVENT_ACCEPTED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_ACCEPTED;
    public static final int EVENT_ACCEPT_FAILED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_ACCEPT_FAILED;

    public static final int EVENT_CLOSED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_CLOSED;
    public static final int EVENT_CLOSE_FAILED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_CLOSE_FAILED;
    public static final int EVENT_DISCONNECTED =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_DISCONNECTED;
    
    public static final int EVENT_ALL =Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENT_ALL;
    ...
    public static class Context {
        ...
        protected Context(int ioThreads) {
            ctx =Armadillo.Communication.zmq.zmq.ZMQ.zmq_init(ioThreads);
        }
    ...
    public static class Socket {
        ...
        private void mayRaise ()
        {
            ...
            if (errno == 0 || errno ==Armadillo.Communication.zmq.zmq.ZError.EAGAIN) ;
            else if (errno ==Armadillo.Communication.zmq.zmq.ZError.ETERM)
        ...
        public final int getType () {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_TYPE);
        }
        ...
        public final long getLinger() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_LINGER);
        }
        ...
        {
            base.setsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_LINGER, (int) linger);
        }
        ...
        public final long getReconnectIVL() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECONNECT_IVL);
        }
        ...
        public final void setReconnectIVL(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECONNECT_IVL, (int)value);
            mayRaise();
        }
        ...
        public final long getBacklog() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_BACKLOG);
        }
        ...
        public final void setBacklog(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_BACKLOG, (int)value);
            mayRaise();
        }
        ...
        public final long getReconnectIVLMax () {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX);
        }
        ...
        public final void setReconnectIVLMax (long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX, (int)value);
            mayRaise();
        }
        ...
        public final long getMaxMsgSize() {
            return (Long)base.getsockoptx(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MAXMSGSIZE);
        }
        ...
        public final void setMaxMsgSize(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MAXMSGSIZE, value);
            mayRaise();
        }
        ...
        public final long getSndHWM() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDHWM);
        }
        ...
        public final void setSndHWM(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDHWM, (int)value);
            mayRaise();
        }
        ...
        public final long getRcvHWM() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVHWM);
        }
        ...
        public final void setRcvHWM(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVHWM, (int)value);
            mayRaise();
        }
        ...
        public final long getAffinity() {
            return (Long)base.getsockoptx(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_AFFINITY);
        }
        ...
        public final void setAffinity(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_AFFINITY, value);
            mayRaise();
        }
        ...
        public final byte[] getIdentity() {
            return (byte[]) base.getsockoptx(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_IDENTITY);
        }
        ...
        public final void setIdentity(byte[] identity) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_IDENTITY, identity);
            mayRaise();
        }
        ...
        public final long getRate() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RATE);
        }
        ...
        public final void setRate(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RATE, (int)value);
            mayRaise();
        }
        ...
        public final long getRecoveryInterval () {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECOVERY_IVL);
        }
        ...
        public final void setRecoveryInterval (long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECOVERY_IVL, (int)value);
            mayRaise();
        }
        ...
        public final long getMulticastHops () {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MULTICAST_HOPS);
        }
        ...
        public final void setMulticastHops (long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MULTICAST_HOPS, (int)value);
            mayRaise();
        }
        ...
        public final int getReceiveTimeOut() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVTIMEO);
        }
        ...
        public final void setReceiveTimeOut(int value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVTIMEO, value);
            mayRaise();
        }
        ...
        public final int getSendTimeOut() {
            return (int)base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDTIMEO);
        }
        ...
        public final void setSendTimeOut(int value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDTIMEO, value);
            mayRaise();
        }
        ...
        public final long getSendBufferSize() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDBUF);
        }
        ...
        public final void setSendBufferSize(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDBUF, (int)value);
            mayRaise();
        }
        ...
        public final long getReceiveBufferSize() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVBUF);
        }
        ...
        public final void setReceiveBufferSize(long value) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVBUF, (int)value);
            mayRaise();
        }
        ...
        {
            return base.getsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVMORE) == 1;
        }
        ...
        public final SelectableChannel getFD() {
            return (SelectableChannel)base.getsockoptx(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_FD);
        }
        ...
        public final int getEvents() {
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_EVENTS);
        }
        ...
        public final void subscribe(byte[] topic) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SUBSCRIBE, topic);
            mayRaise();
        }
        ...
        public final void unsubscribe(byte[] topic) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_UNSUBSCRIBE, topic);
            mayRaise();
        }
        ...
        public final void setEncoder(Class<? extends EncoderBase> cls) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_ENCODER, cls);
        }
        ...
        public final void setDecoder(Class<? extends DecoderBase> cls) {
            base.setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_DECODER, cls);
        }
        ...
        public final void setRouterMandatory (boolean mandatory) {
            base.setsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_ROUTER_MANDATORY, mandatory ? 1 : 0);
        }
        ...
        public final boolean send (String data) {
           Armadillo.Communication.zmq.zmq.Msg msg = new Armadillo.Communication.zmq.zmq.Msg(data);
            return base.send(msg, 0);
        }
        
        public final boolean sendMore (String data) {
           Armadillo.Communication.zmq.zmq.Msg msg = new Armadillo.Communication.zmq.zmq.Msg(data);
            return base.send(msg,Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDMORE);
        }
        ...
        public final boolean sendMore (Msg msg) {
            return base.send(msg.base,Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDMORE);
        }
        ...
        */
        ...
        {
           Armadillo.Communication.zmq.zmq.Msg msg = base.recv(flags);
    ...
    public static class Msg {
        ...
        public final static int MORE =Armadillo.Communication.zmq.zmq.Msg.more;
        private final Armadillo.Communication.zmq.zmq.Msg base;
        
        public Msg () {
            base = new Armadillo.Communication.zmq.zmq.Msg (); //empty message for bottom
        }
        
        public Msg (Armadillo.Communication.zmq.zmq.Msg msg) {
            base = msg;
        }
        
        public Msg (int size) {
            base = new Armadillo.Communication.zmq.zmq.Msg (size);
        }

        public Msg (String data) {
            base = new Armadillo.Communication.zmq.zmq.Msg (data);
        }
    ...
    public static class Poller {
        ...
        private Selector selector;
        private Armadillo.Communication.zmq.zmq.PollItem [] items;
        ...
        protected Poller (Context context, int size) {
            items = new Armadillo.Communication.zmq.zmq.PollItem[size];
            timeout = -1L;
            next = 0;
            open ();
        }
        ...
        public int register (Socket socket, int events) {
            ...
            return insert (new Armadillo.Communication.zmq.zmq.PollItem (socket.base, events));
        }
        ...
        public int register (SelectableChannel channel, int events) {
            ...
            return insert (new Armadillo.Communication.zmq.zmq.PollItem (channel, events));
        }

        private int insert (Armadillo.Communication.zmq.zmq.PollItem item)
        {
            int pos = next++;
            if (pos == items.length) {
               Armadillo.Communication.zmq.zmq.PollItem[] nitems = new Armadillo.Communication.zmq.zmq.PollItem[items.length + SIZE_INCREMENT];
        ...
        public void unregister (Socket socket) {
            for (int pos = 0; pos < items.length ;pos++) {
               Armadillo.Communication.zmq.zmq.PollItem item = items[pos];
        ...
        public int poll(long tout) {
            return Armadillo.Communication.zmq.zmq.ZMQ.zmq_poll (selector, items, tout);
        }
    ...
    public static class PollItem {
        ...
        private final Armadillo.Communication.zmq.zmq.PollItem base;
        
        public PollItem (Socket s, int ops) {
            base = new Armadillo.Communication.zmq.zmq.PollItem (s.base, ops); 
        }

        public PollItem (SelectableChannel s, int ops) {
            base = new Armadillo.Communication.zmq.zmq.PollItem (s, ops); 
        }

        public final Armadillo.Communication.zmq.zmq.PollItem base() {
            return base;
        }
    ...
    {
        return Armadillo.Communication.zmq.zmq.ZMQ.zmq_proxy (sa.base, sb.base, null);
    }
    
    public static int poll (PollItem[] items, long timeout) {
        
       Armadillo.Communication.zmq.zmq.PollItem[] items_ = new Armadillo.Communication.zmq.zmq.PollItem[items.length];
        for (int i=0; i < items.length; i++) {
            items_[i] = items[i].base;
        }
        
        return Armadillo.Communication.zmq.zmq.ZMQ.zmq_poll(items_, timeout);
    }
    ...
    {
      return Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_VERSION_MAJOR;
    }
    ...
    {
      return Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_VERSION_MINOR;
    }
    ...
    {
      return Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_VERSION_PATCH;
    }
    ...
    public static int getFullVersion() {
        return Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MAKE_VERSION(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_VERSION_MAJOR, 
               Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_VERSION_MINOR, 
               Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_VERSION_PATCH);
    }
    ...
    public static int makeVersion ( final int major,
                                    ...
                                    final int patch )
    {
      return Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MAKE_VERSION ( major, minor, patch );
    }
