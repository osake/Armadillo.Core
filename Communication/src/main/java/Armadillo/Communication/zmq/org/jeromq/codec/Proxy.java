...
*/
package Armadillo.Communication.zmq.org.jeromq.codec;

import java.nio.ByteBuffer;

import Armadillo.Communication.zmq.zmq.DecoderBase;
import Armadillo.Communication.zmq.zmq.EncoderBase;
import Armadillo.Communication.zmq.zmq.IMsgSink;
import Armadillo.Communication.zmq.zmq.IMsgSource;
import Armadillo.Communication.zmq.zmq.Msg;

/**
 * Proxy is mostly used when a client can't use zmq socket at any reason.
 * 
 * By extending the ProxyDecoder and ProxyEncoder you can translate non-zmq data intoArmadillo.Communication.zmq.zmq.MSG and vice versa.
