...
import Armadillo.Communication.zmq.org.jeromq.ZMQ.PollItem;

/**
    The ZLoop class provides an event-driven reactor pattern. The reactor
    handlesArmadillo.Communication.zmq.zmq.PollItem items (pollers or writers, sockets or fds), and
...
public class ZLoop {
    ...
    private Armadillo.Communication.zmq.zmq.PollItem[] pollset;             //  zmq_poll set
    ...
    private void rebuild ()
    {
        ...
        pollset = new Armadillo.Communication.zmq.zmq.PollItem[poll_size];
    ...
    public int poller (PollItem item_, IZLoopHandler handler, Object arg)
    {
       ...
       Armadillo.Communication.zmq.zmq.PollItem item = item_.base();
    ...
    public int start ()
    {
        ...
        while (!Thread.currentThread().isInterrupted()) {
            ...
            rc =Armadillo.Communication.zmq.zmq.ZMQ.zmq_poll (selector, pollset, wait);
            if (rc == -1) {
                if (verbose)
