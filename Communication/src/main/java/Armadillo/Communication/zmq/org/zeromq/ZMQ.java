...
import Armadillo.Communication.zmq.zmq.ZError.CtxTerminatedException;
...
public class ZMQ {
    ...
    */
    ...
    public static class Socket {
         ...
         *
         * @return rawArmadillo.Communication.zmq.zmq.SocketBase
         */
        ...
        {
            base.setsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_LINGER, (int) value);
        }
        ...
        public final void setBacklog(long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_BACKLOG, (int)value);
        }
        ...
        public final void setReconnectIVLMax (long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RECONNECT_IVL_MAX, (int)value);
        }
        ...
        public final void setMaxMsgSize(long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_MAXMSGSIZE, value);
        }
        ...
        public final void setSndHWM(long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDHWM, (int)value);
        }
        ...
        public final void setRcvHWM(long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVHWM, (int)value);
        }
        ...
        public final void setAffinity (long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_AFFINITY, value);
        }
        ...
        public final void setIdentity(byte[] identity) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_IDENTITY, identity);
        }
        ...
        public final void setReceiveTimeOut (int value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVTIMEO, value);
        }
        ...
        public final void setSendTimeOut(int value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDTIMEO, value);
        }
        ...
        public final void setSendBufferSize(long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDBUF, (int)value);
        }
        ...
        public final void setReceiveBufferSize(long value) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_RCVBUF, (int)value);
        }
        ...
        public final void subscribe(byte[] topic) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SUBSCRIBE, topic);
        }
        ...
        public final void unsubscribe(byte[] topic) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_UNSUBSCRIBE, topic);
        }
        ...
        public final void setRouterMandatory (boolean mandatory) {
            setsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_ROUTER_MANDATORY, mandatory ? 1 : 0);
        }
        ...
        public final void setXpubVerbose(boolean verbose) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_XPUB_VERBOSE, verbose ? 1 : 0);
        }
        ...
        public final boolean getIPv4Only () {
            return base.getsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_IPV4ONLY) == 1;
        }
        ...
        public void setIPv4Only (boolean v4only) {
            setsockopt (Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_IPV4ONLY, v4only ? 1 : 0);
        }
        ...
        public int getTCPKeepAlive() {
            ...
            return base.getsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_TCP_KEEPALIVE);
        }
        ...
        public void setTCPKeepAlive(int optVal) {
            setsockopt(Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_TCP_KEEPALIVE, (int)optVal);
        }
        ...
        public final boolean sendMore (String data) {
            return send(data.getBytes (),Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDMORE);
        }
        ...
        public final boolean sendMore (byte[] data) {
            return send(data,Armadillo.Communication.zmq.zmq.ZMQ.ZMQ_SNDMORE);
        }
    ...
    public static class Poller {
        ...
        public int poll(long tout) {
           ...
           Armadillo.Communication.zmq.zmq.PollItem[] pollItems = new Armadillo.Communication.zmq.zmq.PollItem[next];
            for (int i = 0; i < next; i++)
                pollItems[i] = items[i].base ();

            return Armadillo.Communication.zmq.zmq.ZMQ.zmq_poll (pollItems, next, tout);
        }
    ...
    public static class PollItem {
        ...
        public PollItem (Socket socket, int ops) {
            this.socket = socket;
            base = new Armadillo.Communication.zmq.zmq.PollItem (socket.base, ops);
        }

        public PollItem (SelectableChannel channel, int ops) {
            base = new Armadillo.Communication.zmq.zmq.PollItem (channel, ops);
            socket = null;
        }

        protected final Armadillo.Communication.zmq.zmq.PollItem base() {
            return base;
        }
    ...
    {
        return Armadillo.Communication.zmq.zmq.ZMQ.zmq_proxy (frontend.base, backend.base, null);
    }
    ...
    {
        return Armadillo.Communication.zmq.zmq.ZMQ.zmq_proxy (frontend.base, backend.base, capture != null ? capture.base: null);
    }
    ...
    public static int poll(PollItem[] items, int count, long timeout) {
       ...
       Armadillo.Communication.zmq.zmq.PollItem[] items_ = new Armadillo.Communication.zmq.zmq.PollItem[count];
        for (int i = 0; i < count; i++) {
            items_[i] = items[i].base;
        }

        return Armadillo.Communication.zmq.zmq.ZMQ.zmq_poll(items_, count, timeout);
    }
